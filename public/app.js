...
const CATEGORIAS = [
  {
    ...
    lema: 'Herramienta manual, medición y fijaciones. Lo que se gasta y se repone todos los meses en cualquier taller.',
    productos: [
      { n: 'Juego de llaves combinadas 14 piezas', m: 'Truper', p: 34.00, pa: 42.00, img: 'llaves-combinadas', et: 'oferta', v: 4.8 },
      { n: 'Set de destornilladores aislados 12 piezas', m: 'Stanley', p: 16.90, img: 'set-destornilladores', v: 4.9 },
      { n: 'Martillo de uña 16 oz mango de fibra', m: 'Stanley', p: 9.80, img: 'martillo-una', v: 4.9 },
      { n: 'Alicate universal 8" aislado 1000 V', m: 'Total', p: 8.90, img: 'alicate-universal', v: 4.6 },
      { n: 'Cinta métrica 8 m con freno y clip', m: 'Truper', p: 7.50, img: 'cinta-metrica', v: 4.7 },
  ...
  },
  {
    ...
    lema: 'Equipos para turno completo, con garantía, repuestos y servicio técnico propio.',
    productos: [
  ...
  },
  {
    ...
    lema: 'Dotación de personal, trabajo en altura y control de acceso. Despachamos dotaciones completas por contrato.',
    productos: [
      ...
      { n: 'Cerradura de seguridad doble paso', m: 'Yale', p: 24.50, img: 'cerradura-seguridad', v: 4.7 },
    ],
  },
  {
    id: 'electricidad',
    nombre: 'Electricidad y control',
    lema: 'Conductores, protección, tomas y medición. Todo con certificación para instalación industrial.',
    productos: [
  ...
  {
    id: 'fluidos',
    nombre: 'Plomería y fluidos',
    lema: 'Tubería, válvulas, grifería y sellantes para redes de agua, aire y drenaje.',
    productos: [
      ...
      { n: 'Manguera reforzada 15 m para servicio', m: 'Rotoplas', p: 19.90, img: 'manguera-jardin', v: 4.4 },
    ],
  },
];

const ESTRELLAS = [
  { n: 'Discos de corte 4½" (paquete de 10)', m: 'Bosch', p: 9.20, pa: 11.50, img: 'disco-corte', et: 'oferta', v: 4.9 },
  ...
  { n: 'Pintura anticorrosiva blanca (galón)', m: 'Montana', p: 18.50, pa: 23.00, img: 'pintura-caucho', et: 'oferta', v: 4.7 },
...
const TODOS = [
  ...
  ...ESTRELLAS.map((p) => ({ ...p, cat: 'Los que más salen', catId: 'estrellas' })),
];
...
/* ---------------------------------------------------------
   10. COTIZACIÓN (contador) Y TOSTADA
   --------------------------------------------------------- */
let enCarrito = 0;
...
document.addEventListener('click', (e) => {
  ...
  avisar(`Agregado a la cotización: ${btn.dataset.agregar}`);
});
